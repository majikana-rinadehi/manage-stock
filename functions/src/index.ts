 ...
 * @param data
 */
const sendingMail = async (data: MailData): Promise<void> => {
 ...
 */
const helloingWorld = async (request:/** TODO: specify type*/any, response:any): Promise<void> => {
 ...
 * @param context 
 */
const sendingLine = async (data: LineData): Promise<void> => {
